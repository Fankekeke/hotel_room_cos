...
export default {
  ...
  methods: {
    ...
    add () {
      this.deptAdd.visiable = true
    },
    handledeptAddClose () {
      this.deptAdd.visiable = false
    },
    ...
    edit (record) {
      ...
      this.deptEdit.visiable = true
    },
    handledeptEditClose () {
      this.deptEdit.visiable = false
    },
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/dept-info/' + ids).then(() => {
